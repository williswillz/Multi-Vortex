...
for i in range (0, 500):
    ...
    xvort10[a,0] = i
    xvort10[a,1] = 0.22
    vel10[:,:] = panels.induced_velocity_single(q, xvort10, 0.5)
    a = a + 1
...
for i in range (0, 500):
    ...
    xvort11[a,0] = i
    xvort11[a,1] = 0.33
    vel11[:,:] = panels.induced_velocity_single(q, xvort11, 0.5)
    a = a + 1
...
for i in range (0, 500):
    ...
    xvort12[a,0] = i
    xvort12[a,1] = 0.44
    vel12[:,:] = panels.induced_velocity_single(q, xvort12, 0.5)
    a = a + 1
...
for i in range (0, 500):
    ...
    xvort13[a,0] = i
    xvort13[a,1] = 0.55
    vel13[:,:] = panels.induced_velocity_single(q, xvort13, 0.5)
    a = a + 1
...
for i in range (0, 500):
    ...
    xvort14[a,0] = i
    xvort14[a,1] = 0.66
    vel14[:,:] = panels.induced_velocity_single(q, xvort14, 0.5)
    a = a + 1
...
for i in range (0, 500):
    ...
    xvort15[a,0] = i
    xvort15[a,1] = 0.77
    vel15[:,:] = panels.induced_velocity_single(q, xvort15, 0.5)
    a = a + 1
...
for i in range (0, 500):
    ...
    xvort16[a,0] = i
    xvort16[a,1] = 0.88
    vel16[:,:] = panels.induced_velocity_single(q, xvort16, 0.5)
    a = a + 1
