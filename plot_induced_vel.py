...
for i in range (0, 500):
    ...
    xvort2[a,0] = i
    xvort2[a,1] = 0
    vel2[:,:] = panels.induced_velocity_single(q, xvort2, -0.24)
    a = a + 1
...
savetxt('single-vortex_two'+str()+'.csv',np.column_stack((vel1[:],vel2[:],vel3[:])), fmt='%5s', delimiter=',')
