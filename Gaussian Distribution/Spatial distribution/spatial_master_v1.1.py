...
for i in range (0, total_num):
    ...
    xvort1[a,0] = i
    xvort1[a,1] = 0
    vel1[:,:] = induced_velocity_single(q, xvort1, random.uniform(-1,1), core_radius[a])
    a = a + 1
...
ax0 = fig.add_subplot(611).set_title('Vortices injection from X=0 using Normal distribution')
ax0 = plt.scatter(q[:,0],q[:,1], label='vortex')
ax0 = fig.add_subplot(611).legend(loc='best')
