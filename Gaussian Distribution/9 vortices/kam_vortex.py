...
savetxt('single-vortex_two_saya'+str()+'.csv',np.column_stack((vel1[:],vel2[:],vel3[:])), fmt='%5s', delimiter=',')
...
plt.legend(loc='upper left')
savefig('induced_velocity_individual_saya.pdf')
plt.show()
...
plt.legend(loc='upper left')
savefig('induced_velocity_saya.pdf')
plt.show()
