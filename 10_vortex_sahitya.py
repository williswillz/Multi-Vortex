...
savetxt('single-vortex_10_sahitya'+str()+'.csv',np.column_stack((t, vel_tot_mag[:])), fmt='%5s', delimiter=',')
...
plt.legend(loc='best')
savefig('induced_velocity_individual_10_sahitya.pdf')
plt.show()
...
plt.legend(loc='best')
savefig('induced_velocity_10_sahitya.pdf')
plt.show()
