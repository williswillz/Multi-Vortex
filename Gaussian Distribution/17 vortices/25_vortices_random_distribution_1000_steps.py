...
xvort1 = np.zeros((1000,2))
vel1 = np.zeros((1000,2))
q = np.zeros((1000,2))
a = 0
...
xvort2 = np.zeros((1000,2))
vel2 = np.zeros((1000,2))
a = 0
...
xvort3 = np.zeros((1000,2))
vel3 = np.zeros((1000,2))
a = 0
...
xvort4 = np.zeros((1000,2))
vel4 = np.zeros((1000,2))
a = 0
...
xvort5 = np.zeros((1000,2))
vel5 = np.zeros((1000,2))
a = 0
...
xvort6 = np.zeros((1000,2))
vel6 = np.zeros((1000,2))
a = 0
...
xvort7 = np.zeros((1000,2))
vel7 = np.zeros((1000,2))
a = 0
...
xvort8 = np.zeros((1000,2))
vel8 = np.zeros((1000,2))
a = 0
...
xvort9 = np.zeros((1000,2))
vel9 = np.zeros((1000,2))
a = 0
...
xvort10 = np.zeros((1000,2))
vel10 = np.zeros((1000,2))
a = 0
...
xvort11 = np.zeros((1000,2))
vel11 = np.zeros((1000,2))
a = 0
...
xvort12 = np.zeros((1000,2))
vel12 = np.zeros((1000,2))
a = 0
...
xvort13 = np.zeros((1000,2))
vel13 = np.zeros((1000,2))
a = 0
...
xvort14 = np.zeros((1000,2))
vel14 = np.zeros((1000,2))
a = 0
...
xvort15 = np.zeros((1000,2))
vel15 = np.zeros((1000,2))
a = 0
...
xvort16 = np.zeros((1000,2))
vel16 = np.zeros((1000,2))
a = 0
...
savetxt('25vertical_var_rand_1000'+str()+'.csv',np.column_stack((t,vel_tot[:])), fmt='%5s', delimiter=',')
...
plt.legend(loc='upper right')
savefig(str(number_of_vortices)+'_vortices_u_velocity_rand_1000.pdf')
plt.show()
...
plt.legend(loc='upper right')
savefig(str(number_of_vortices)+'_vortices_v_velocity_rand_1000.pdf')
plt.show()
...
plt.legend(loc='best')
savefig(str(number_of_vortices)+'_vortices_total_velocity_rand_1000.pdf')
plt.show()
...
ax.set_xscale('log')
savefig('frequency_(5,1)_rand_1000'+str(N)+str(number_of_vortices)+'.pdf')
plt.show()
...
ax.plot(xf, 2.0/N * np.abs(yf[:N//2]))
ax.set_xscale('log')
savefig('frequency_vsquare(5,1)_rand_1000'+str(N)+str(number_of_vortices)+'.pdf')
plt.show()